...
import com.example.antony.tp_meteo.exception.BadJsonExpectedException;
 ...
 * @author antony
 * @version 1.0.2
 * @see com.example.antony.tp_meteo.SQLite.SQLiteConstante
 *
 */
public abstract class AbstractDAO<T> implements SQLiteConstante{
     ...
     */
    protected void close(){ bdd.close(); }
     ...
     * @throws BadJsonExpectedException Si le json ne correspond pas a l'objet a inserer
     */
    public abstract void insertByJson(JSONArray jsonArray) throws BadJsonExpectedException;
